...
// const listado = Array.from(document.querySelectorAll('li'));
// console.log(listado);

// const aprender = listado.map(elemento => elemento.textContent);
// console.log(aprender) // error:  listado.map is not a function porque listado es un NodeList no un Array

const aprender = Array.from(
...
function total(num1, num2, num3, num4, num5, num6) {
    return Array.from(arguments).reduce((ant, sig) => 
        ant + sig, 0);    
}

console.log(total(23,4,5556,12,5433,31));
...
// Array.find(): El método find() devuelve el valor del primer elemento del array que cumple la función de prueba proporcionada.

// https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/find

// Correo electronico a buscar:
const correoe = "umut.velioglu@example.com";

// Busco por el correo electronico al usuario 
const usuarioSeleccionado = users.find(user => user.email == correoe);
console.log(usuarioSeleccionado);

// Array.findIndex(): El método indexOf() retorna el primer índice en el que se puede encontrar un elemento dado en el array, ó retorna -1 si el elemento no esta presente.

// https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/findIndex

const uuid = "2a60d53c-24f2-4409-9990-2f5fd55d14eb";
const indiceSeleccionado = users.findIndex(user => user.login.uuid === uuid);

// Borro el usuario seleccionado a traves de su indice
users.splice(indiceSeleccionado, 1);
console.log(users);

// Array.filter(): El método filter() crea un nuevo array con todos los elementos que cumplan la condición implementada por la función dada.
...
// Array.includes(): El método includes() determina si una matriz incluye un determinado elemento, devuelve true o false según corresponda.

// https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/includes

console.log(Array.of(1,2,3,4,5,6).includes(3)); // output]: true
console.log(Array.of(1,2,3,4,5,6).includes(9)); // output]: false
